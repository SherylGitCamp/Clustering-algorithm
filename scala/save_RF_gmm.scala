...
object save_RF_gmm {
  def main(args: Array[String]) {
    ...
    // read labeled data
    val readDF = sqlContext.read.json("/home/v/Desktop/gmmJSON_10class/part*.json")
        readDF.show(10)
...
//    val inputDF = assembler.transform(readDF).drop("probability")
//        inputDF.show(10)
//
//    val splitSeed = 5043
//    val Array(trainingData, testData) = inputDF.randomSplit(Array(0.75, 0.25), splitSeed)
...
//    model.write.save("/home/v/Downloads/saved_RF_gmm")
//
//    //predict
